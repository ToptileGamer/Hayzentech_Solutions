    ...
    <div className="admin-page portal-layout admin-theme">
      ...
      <aside className={`admin-sidebar portal-sidebar ${menuOpen ? "open" : ""}`}>
        ...
        <nav className="admin-nav" onClick={closeMenu}>
          <Link
            to="/admin"
            className={`admin-nav-item ${location.pathname === "/admin" && !location.search.includes("view=") ? "active" : ""}`}
          >
            <MdDashboard /> Dashboard
          </Link>
          <Link
            to="/admin?view=orders"
            className={`admin-nav-item ${location.search.includes("view=orders") ? "active" : ""}`}
          >
            <MdReceipt /> Orders
          </Link>
          <Link
            to="/admin?view=clients"
            className={`admin-nav-item ${location.search.includes("view=clients") ? "active" : ""}`}
          >
            <MdPeople /> Clients
          </Link>
