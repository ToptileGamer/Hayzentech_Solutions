    ...
    <>
      <div className="header">
        ...
        <ul className="desktop-nav">
          ...
          {!user ? (
            <>
              <li>
                <Link to="/contact" className="navbar-contact-btn" data-cursor="disable">
                  CONTACT ME
                </Link>
              </li>
              <li>
                <Link to="/login" className="navbar-auth-link" data-cursor="disable">
                  LOGIN
                </Link>
              </li>
            </>
            ...
            <>
              <li className="navbar-user-item">
                <Link to="/dashboard" className="navbar-user-greeting" data-cursor="disable">
                  {profile?.full_name || user?.email}
                </Link>
              </li>
              <li>
                <Link to="/dashboard" className="navbar-auth-link" data-cursor="disable">
                  DASHBOARD
                </Link>
              </li>
              {isAdmin && (
      ...
      <div className={`mobile-nav-overlay ${menuOpen ? "open" : ""}`}>
        <ul>
          ...
          {user ? (
            <>
              <li className="navbar-user-item-mobile">
                <Link to="/dashboard" className="navbar-user-greeting-mobile" onClick={() => setMenuOpen(false)}>
                  {profile?.full_name || user?.email}
                </Link>
              </li>
              <li>
